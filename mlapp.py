...
car = pd.read_excel(r'data\features\car_features_without_impute.xlsx')
...
with st.spinner("Hold on, the app is loading..."):
    model = model_loader(r"C:\Users\loges\Documents\GitHub\ML-App\models\xgb1_model.pkl")
    scaler=model_loader(r"C:\Users\loges\Documents\GitHub\ML-App\models\SDscaler_model.pkl")
...
inp_array = np.array([fuel_type,body_type,miles_driven,brand_inp,model_inp,transmission_type,ownership,year,engineV,seats_inp])

inp_array = inp_array.reshape(1,-1)
inp_array = scaler.transform(inp_array)
...
prj_info = """ 
            ...
            Then just click on predict button, I recommend to choose 'XgBoost Regressor' for predict the price because it will give more accurate 
            result than other model i tried.\n
            
            I am sharing the full project's code source along with dataset. \n
            Only want to look at the code? - [Github](https://github.com/keerthi-ds777) \n
